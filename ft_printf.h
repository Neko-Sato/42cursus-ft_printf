...
/*   Updated: 2025/09/07 16:49:50 by hshimizu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef va_list		*t__printf_va_list_ref;
# else
#  define _VARG_REF 0
...
signed int			ft__printf_va_arg_signed_int(
						t__printf_va_list_ref ap);
signed long			ft__printf_va_arg_signed_long(
						t__printf_va_list_ref ap);
signed long long	ft__printf_va_arg_signed_long_long(
						t__printf_va_list_ref ap);
unsigned int		ft__printf_va_arg_unsigned_int(
						t__printf_va_list_ref ap);
unsigned long		ft__printf_va_arg_unsigned_long(
						t__printf_va_list_ref ap);
unsigned long long	ft__printf_va_arg_unsigned_long_long(
						t__printf_va_list_ref ap);
void				*ft__printf_va_arg_pointer(
						t__printf_va_list_ref ap);
char				*ft__printf_va_arg_string(
						t__printf_va_list_ref ap);
...
size_t				ft__printf_handler_char(t_ostream *os,
						const t__printf_specifier *spec,
						t__printf_va_list_ref ap);
